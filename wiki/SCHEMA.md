...
每个页面是一个独立 markdown 文件，YAML frontmatter + 正文。正文中用 `[[页名]]` 互链。
...
| `entity` | 具体证券、行业、研究对象 | `entities/`（按需） |
...
- 人写：`concepts/momentum.md`、`operators/ts_decay_linear.md`、`fields/fnd72_pit_or_cr_q_oper_inc_to_tot_debt.md`
